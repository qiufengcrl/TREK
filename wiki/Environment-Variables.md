...
| `AMAP_API_KEY`            | Optional [Amap (高德) Web service](https://console.amap.com/) key. When set, place search / autocomplete / details / reverse geocoding use Amap first (coordinates converted GCJ-02 → WGS-84). Can also be set in Admin → Settings → API Keys. | — |
