 ...
 * GCJ-02 (火星坐标) ↔ WGS-84.
 *
 * Amap / 天地图 / 国内电子地图用 GCJ-02；TREK 存库和 OSM / Carto 底图是 WGS-84.
 * 境外点原样返回。Client 和 server 都 import 这里，不要再各写一份。
 */
...
/** Approximate inverse: one-step reflection. Plenty for a map pin. */
