...
const places: TranslationStrings = {
  ...
  'places.osmHint': '使用 OpenStreetMap 搜索（无照片、营业时间或评分）。国内请添加高德 Key；添加 Google Key 可获得评分和营业时间。',
  'places.osmActive': '正在使用 OpenStreetMap。国内更适合配置高德 Key；Google Key 可获得评分和营业时间。',
  'places.amapActive': '正在使用高德搜索地点',
  ...
  'places.details.noKeyHint': '没有 Google API 密钥时，评分、营业时间和照片只能使用免费来源。请联系 TREK 管理员添加 Google Key，或添加高德 Key 用于国内搜索。',
