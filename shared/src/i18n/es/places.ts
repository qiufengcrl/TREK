...
const places: TranslationStrings = {
  ...
  'places.osmHint': 'Usando búsqueda con OpenStreetMap (sin fotos, horarios ni valoraciones). Añade una clave Amap para China, o una clave de Google para valoraciones y horarios.',
  'places.osmActive': 'Se usa OpenStreetMap. Una clave Amap encaja mejor en China; una clave de Google añade valoraciones y horarios.',
  'places.amapActive': 'Usando Amap (Gaode) para buscar lugares',
  ...
  'places.details.noKeyHint': 'Sin una clave de API de Google, esta instancia solo usa fuentes libres para valoraciones, horarios y fotos. Pide a tu administrador de TREK que añada una clave de Google, o una clave Amap para búsquedas en China.',
