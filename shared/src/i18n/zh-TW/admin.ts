...
const admin: TranslationStrings = {
  ...
  'admin.apiKeysHint': '可選。設定高德 Key 後，國內地點搜尋、底圖、路線和天氣會優先走高德。Google Key 用於照片、評分和營業時間。',
  'admin.amapKey': '高德 Web 服務 Key',
  'admin.amapKeyHintLong': '設定後，地點搜尋、補全、詳情和逆地理會優先走高德。空結果或失敗會回落到 OpenStreetMap（不再嘗試 Google）。請在 console.amap.com 申請 Web 服務 Key，不要填進 Google 欄。',
  'admin.mapsKey': 'Google Maps API 金鑰',
  'admin.mapsKeyHint': '用於地點搜尋。在 console.cloud.google.com 獲取',
  'admin.mapsKeyHintLong': '僅在未設定高德 Key 時使用。沒有 Google 或高德 Key 時用 OpenStreetMap 搜尋。Google Key 還可載入照片、評分和營業時間。在 console.cloud.google.com 取得。',
