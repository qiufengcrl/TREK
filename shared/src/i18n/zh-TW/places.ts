...
const places: TranslationStrings = {
  ...
  'places.osmHint': '使用 OpenStreetMap 搜尋（無照片、營業時間或評分）。國內請新增高德 Key；新增 Google Key 可取得評分與營業時間。',
  'places.osmActive': '正在使用 OpenStreetMap。國內更適合設定高德 Key；Google Key 可取得評分與營業時間。',
  'places.amapActive': '正在使用高德搜尋地點',
  ...
  'places.details.noKeyHint': '沒有 Google API 金鑰時，評分、營業時間和照片只能使用免費來源。請聯絡 TREK 管理員新增 Google Key，或新增高德 Key 用於國內搜尋。',
