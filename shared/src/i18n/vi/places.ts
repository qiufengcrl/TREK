...
const places: TranslationStrings = {
  ...
  'places.osmHint': 'Sử dụng tìm kiếm OpenStreetMap (không có ảnh, giờ mở cửa hoặc xếp hạng). Thêm khóa Amap cho Trung Quốc, hoặc khóa Google cho xếp hạng và giờ mở cửa.',
  'places.osmActive': 'Đang dùng OpenStreetMap. Khóa Amap phù hợp hơn với Trung Quốc; khóa API Google bổ sung đánh giá và giờ mở cửa.',
  'places.amapActive': 'Đang tìm địa điểm bằng Amap (Gaode)',
  ...
  'places.details.noKeyHint': 'Không có khóa API Google thì xếp hạng, giờ mở cửa và ảnh chỉ lấy từ nguồn miễn phí. Hãy đề nghị quản trị viên TREK thêm khóa Google, hoặc khóa Amap để tìm ở Trung Quốc.',
