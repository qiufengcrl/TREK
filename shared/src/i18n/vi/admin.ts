...
const admin: TranslationStrings = {
  ...
  'admin.apiKeysHint': 'Không bắt buộc. Khóa Amap được dùng trước cho tìm kiếm địa điểm, lát bản đồ, tuyến đường và thời tiết ở Trung Quốc. Khóa Google bổ sung ảnh, xếp hạng và giờ mở cửa.',
  'admin.amapKey': 'Khóa API Web Amap (Gaode)',
  'admin.amapKeyHintLong': 'Khi đã đặt, tìm kiếm địa điểm, tự hoàn thành, chi tiết và geocode ngược thử Amap trước. Kết quả trống hoặc lỗi chuyển sang OpenStreetMap (bỏ qua Google). Khóa dịch vụ web tại console.amap.com. Đừng dán vào ô Google.',
  'admin.mapsKey': 'Google Maps API Key',
  'admin.mapsKeyHint': 'Cần thiết cho tìm kiếm địa điểm. Truy cập tại console.cloud.google.com',
  'admin.mapsKeyHintLong': 'Dùng khi chưa có khóa Amap. Không có khóa Google hoặc Amap thì tìm bằng OpenStreetMap. Khóa Google cũng có thể tải ảnh, xếp hạng và giờ mở cửa. Lấy tại console.cloud.google.com.',
