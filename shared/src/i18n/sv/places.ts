...
const places: TranslationStrings = {
  ...
  'places.osmHint': 'Använder OpenStreetMap-sökningen (inga bilder, öppettider eller betyg). Lägg till en Amap-nyckel för Kina, eller en Google-nyckel för betyg och öppettider.',
  'places.osmActive': 'OpenStreetMap används. En Amap-nyckel passar bättre för Kina; en Google API-nyckel lägger till betyg och öppettider.',
  'places.amapActive': 'Söker platser med Amap (Gaode)',
  ...
  'places.details.noKeyHint': 'Utan en Google API-nyckel använder den här instansen bara fria källor för betyg, öppettider och foton. Be din TREK-administratör lägga till en Google-nyckel, eller en Amap-nyckel för sökning i Kina.',
