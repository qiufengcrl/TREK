...
const places: TranslationStrings = {
  ...
  'places.osmHint': 'OpenStreetMap araması (fotoğraf, açılış saati veya puan yok). Çin için Amap anahtarı, puan ve saatler için Google anahtarı ekleyin.',
  'places.osmActive': 'OpenStreetMap kullanılıyor. Çin için Amap anahtarı daha uygundur; Google API anahtarı puan ve çalışma saatleri ekler.',
  'places.amapActive': 'Yer araması Amap (Gaode) ile yapılıyor',
  ...
  'places.details.noKeyHint': 'Google API anahtarı olmadan puanlar, açılış saatleri ve fotoğraflar yalnızca özgür kaynaklardan gelir. TREK yöneticinizden bir Google anahtarı veya Çin araması için Amap anahtarı eklemesini isteyin.',
