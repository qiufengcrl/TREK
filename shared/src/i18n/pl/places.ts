...
const places: TranslationStrings = {
  ...
  'places.osmHint': 'Wyszukiwanie OpenStreetMap (brak zdjęć, godzin otwarcia i ocen). Dodaj klucz Amap dla Chin albo klucz Google dla ocen i godzin otwarcia.',
  'places.osmActive': 'Używany jest OpenStreetMap. Klucz Amap lepiej pasuje do Chin; klucz Google API dodaje oceny i godziny otwarcia.',
  'places.amapActive': 'Wyszukiwanie miejsc przez Amap (Gaode)',
  ...
  'places.details.noKeyHint': 'Bez klucza API Google ta instancja korzysta tylko ze źródeł otwartych dla ocen, godzin otwarcia i zdjęć. Poproś administratora TREK o dodanie klucza Google albo klucza Amap do wyszukiwania w Chinach.',
