...
const places: TranslationStrings = {
  ...
  'places.osmHint': 'Zoeken via OpenStreetMap (geen foto’s, openingstijden of beoordelingen). Voeg een Amap-sleutel toe voor China, of een Google-sleutel voor beoordelingen en openingstijden.',
  'places.osmActive': 'OpenStreetMap wordt gebruikt. Een Amap-sleutel past beter bij China; een Google API-sleutel voegt beoordelingen en openingstijden toe.',
  'places.amapActive': 'Plaatsen zoeken met Amap (Gaode)',
  ...
  'places.details.noKeyHint': 'Zonder Google API-sleutel gebruikt deze installatie alleen vrije bronnen voor beoordelingen, openingstijden en foto’s. Vraag je TREK-beheerder om een Google-sleutel, of een Amap-sleutel voor zoeken in China.',
