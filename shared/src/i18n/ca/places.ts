...
const places: TranslationStrings = {
  ...
  'places.osmHint': 'S’està utilitzant la cerca amb OpenStreetMap (sense fotos, horaris ni valoracions). Afegeix una clau Amap per a la Xina, o una clau de Google per a valoracions i horaris.',
  'places.osmActive': 'S’utilitza OpenStreetMap. Una clau Amap encaixa millor a la Xina; una clau API de Google afegeix valoracions i horaris.',
  'places.amapActive': 'S’està cercant llocs amb Amap (Gaode)',
  ...
  'places.details.noKeyHint': 'Sense una clau API de Google, aquesta instància només fa servir fonts lliures per a valoracions, horaris i fotos. Demana a l’administració de TREK que n’afegeixi una, o una clau Amap per cercar a la Xina.',
