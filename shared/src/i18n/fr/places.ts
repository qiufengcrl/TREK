...
const places: TranslationStrings = {
  ...
  'places.osmHint': 'Recherche via OpenStreetMap (pas de photos, horaires ni notes). Ajoutez une clé Amap pour la Chine, ou une clé Google pour les notes et horaires.',
  'places.osmActive': 'OpenStreetMap est utilisé. Une clé Amap convient mieux à la Chine ; une clé API Google ajoute notes et horaires.',
  'places.amapActive': 'Recherche de lieux via Amap (Gaode)',
  ...
  'places.details.noKeyHint': 'Sans clé API Google, cette instance n’utilise que des sources libres pour les avis, horaires et photos. Demandez à votre administrateur TREK d’ajouter une clé Google, ou une clé Amap pour la recherche en Chine.',
