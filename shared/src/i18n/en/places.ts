...
const places: TranslationStrings = {
  ...
  'places.osmHint': 'Using OpenStreetMap search (no photos, opening hours, or ratings). Add an Amap key for China, or a Google key for ratings and opening hours.',
  'places.osmActive': 'Using OpenStreetMap. An Amap key is better for China; a Google key adds ratings and opening hours.',
  ...
  'places.details.noKeyHint': 'Without a Google API key this instance can only use free sources for ratings, opening hours and photos. Ask your TREK administrator to add a Google key, or an Amap key for China search.',
