...
const places: TranslationStrings = {
  ...
  'places.osmHint': 'يتم البحث عبر OpenStreetMap (بدون صور أو ساعات عمل أو تقييمات). أضف مفتاح Amap للصين، أو مفتاح Google للتقييمات وساعات العمل.',
  'places.osmActive': 'يتم استخدام OpenStreetMap. مفتاح Amap أنسب للصين؛ مفتاح Google API يضيف التقييمات وساعات العمل.',
  'places.amapActive': 'يتم البحث عن الأماكن عبر Amap (Gaode)',
  ...
  'places.details.noKeyHint': 'بدون مفتاح Google API تأتي التقييمات وساعات العمل والصور من مصادر حرة فقط. اطلب من مسؤول TREK إضافة مفتاح Google، أو مفتاح Amap للبحث في الصين.',
