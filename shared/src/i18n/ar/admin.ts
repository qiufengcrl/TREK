...
const admin: TranslationStrings = {
  ...
  'admin.apiKeysHint': 'اختياري. يُستخدم مفتاح Amap أولاً لبحث الأماكن والبلاط والمسارات والطقس في الصين. يضيف مفتاح Google الصور والتقييمات وساعات العمل.',
  'admin.amapKey': 'مفتاح واجهة Amap (Gaode) للويب',
  'admin.amapKeyHintLong': 'عند التعيين، يجرب البحث والإكمال التلقائي والتفاصيل والترميز الجغرافي العكسي Amap أولاً. النتيجة الفارغة أو الخطأ تنتقل إلى OpenStreetMap (يتم تخطي Google). مفتاح خدمة الويب من console.amap.com. لا تضعه في حقل Google.',
  'admin.mapsKey': 'مفتاح Google Maps API',
  'admin.mapsKeyHint': 'مطلوب للبحث عن الأماكن. احصل عليه من console.cloud.google.com',
  'admin.mapsKeyHintLong': 'يُستخدم عندما لا يوجد مفتاح Amap. بدون مفتاح Google أو Amap يُستخدم OpenStreetMap للبحث. يمكن لمفتاح Google أيضاً تحميل الصور والتقييمات وساعات العمل. احصل عليه من console.cloud.google.com.',
