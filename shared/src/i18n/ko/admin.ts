...
const admin: TranslationStrings = {
  ...
  'admin.apiKeys': 'API 키',
  'admin.apiKeysHint': '선택 사항. Amap 키가 있으면 중국 장소 검색, 타일, 경로, 날씨를 먼저 사용합니다. Google 키는 사진, 평점, 영업 시간을 추가합니다.',
  'admin.amapKey': 'Amap (Gaode) 웹 API 키',
  'admin.amapKeyHintLong': '설정하면 장소 검색, 자동완성, 상세, 역지오코딩이 먼저 Amap을 사용합니다. 비어 있거나 실패하면 OpenStreetMap으로 넘어갑니다(Google은 건너뜁니다). Web 서비스 키는 console.amap.com. Google 칸에 넣지 마세요.',
  'admin.mapsKey': 'Google Maps API 키',
  'admin.mapsKeyHint': '장소 검색에 필요합니다. console.cloud.google.com에서 발급',
  'admin.mapsKeyHintLong': 'Amap 키가 없을 때만 사용합니다. Google 또는 Amap 키가 없으면 OpenStreetMap으로 검색합니다. Google 키가 있으면 사진, 평점, 영업 시간도 불러올 수 있습니다. console.cloud.google.com에서 발급하세요.',
