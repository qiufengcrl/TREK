...
const places: TranslationStrings = {
  ...
  'places.osmHint': 'OpenStreetMap 검색 사용 중 (사진, 영업 시간, 평점 없음). 중국은 Amap 키를, 평점과 영업 시간은 Google 키를 추가하세요.',
  'places.osmActive': 'OpenStreetMap을 사용 중입니다. 중국에는 Amap 키가 더 적합하고, Google API 키를 추가하면 평점과 영업시간이 표시됩니다.',
  'places.amapActive': '장소 검색에 Amap (Gaode) 사용 중',
  ...
  'places.details.noKeyHint': 'Google API 키가 없으면 평점, 영업시간, 사진은 무료 소스만 사용합니다. TREK 관리자에게 Google 키, 또는 중국 검색용 Amap 키 추가를 요청하세요.',
