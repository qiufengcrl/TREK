...
const places: TranslationStrings = {
  ...
  'places.osmHint': 'Пошук через OpenStreetMap (без фото, годин роботи та рейтингів). Додайте ключ Amap для Китаю або ключ Google для рейтингів і годин роботи.',
  'places.osmActive': 'Використовується OpenStreetMap. Ключ Amap краще підходить для Китаю; ключ Google API додасть рейтинги та години роботи.',
  'places.amapActive': 'Пошук місць через Amap (Gaode)',
  ...
  'places.details.noKeyHint': 'Без ключа Google API оцінки, години роботи та фото беруться лише з вільних джерел. Попросіть адміністратора TREK додати ключ Google або ключ Amap для пошуку в Китаї.',
