...
const admin: TranslationStrings = {
  ...
  'admin.apiKeysHint': 'Volitelné. Klíč Amap se použije jako první pro hledání míst, dlaždice, trasy a počasí v Číně. Klíč Google přidá fotky, hodnocení a otevírací dobu.',
  'admin.amapKey': 'Webový API klíč Amap (Gaode)',
  'admin.amapKeyHintLong': 'Pokud je nastaven, hledání míst, doplňování, detaily a reverzní geokódování nejdřív zkusí Amap. Prázdný výsledek nebo chyba spadne na OpenStreetMap (Google se přeskočí). Klíč webové služby: console.amap.com. Nedávejte ho do pole Google.',
  'admin.mapsKey': 'Google Maps API klíč',
  'admin.mapsKeyHint': 'Povinné pro hledání míst. Získáte na console.cloud.google.com',
  'admin.mapsKeyHintLong': 'Použije se, když není nastaven klíč Amap. Bez klíče Google nebo Amap se hledá přes OpenStreetMap. Klíč Google umí načíst i fotky, hodnocení a otevírací dobu. Získáte na console.cloud.google.com.',
