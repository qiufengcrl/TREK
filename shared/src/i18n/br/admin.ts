...
const admin: TranslationStrings = {
  ...
  'admin.apiKeysHint': 'Opcional. Uma chave Amap é usada primeiro para busca, tiles, rotas e clima na China. Uma chave Google adiciona fotos, avaliações e horários.',
  'admin.amapKey': 'Chave da API Web Amap (Gaode)',
  'admin.amapKeyHintLong': 'Quando definida, busca, autocompletar, detalhes e geocodificação inversa tentam a Amap primeiro. Resultado vazio ou erro cai no OpenStreetMap (o Google é ignorado). Chave de serviço web em console.amap.com. Não cole no campo do Google.',
  ...
  'admin.mapsKeyHintLong': 'Usada quando não há chave Amap. Sem chave Google ou Amap, a busca usa OpenStreetMap. Uma chave Google também pode carregar fotos, avaliações e horários. Obtenha em console.cloud.google.com.',
