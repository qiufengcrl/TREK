...
const places: TranslationStrings = {
  ...
  'places.osmHint': 'Busca via OpenStreetMap (sem fotos, horários ou avaliações). Adicione uma chave Amap para a China, ou uma chave Google para avaliações e horários.',
  'places.osmActive': 'Usando o OpenStreetMap. Uma chave Amap combina melhor com a China; uma chave de API do Google adiciona avaliações e horários.',
  'places.amapActive': 'Buscando lugares com Amap (Gaode)',
  ...
  'places.details.noKeyHint': 'Sem uma chave de API do Google, esta instância usa só fontes livres para avaliações, horários e fotos. Peça ao administrador do TREK para adicionar uma chave Google, ou uma chave Amap para busca na China.',
