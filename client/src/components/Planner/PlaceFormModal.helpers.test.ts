...
describe('shareResolveToResult + mergeResult', () => {
  ...
  it('leaves missing share fields undefined so a mobile pick does not write blanks', () => {
    expect(shareResolveToResult({ lat: 48.86, lng: 2.33, name: null, address: null, google_ftid: null })).toEqual({
      name: undefined,
      address: undefined,
      lat: '48.86',
      lng: '2.33',
